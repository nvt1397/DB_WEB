...
?>
<form method="POST" action="store_lesson.php" role="form">
<div class="col-lg-6">
    <div class="form-group">
        <label for="lessonID">LessonID:</label>
        <input id="lessonID" name="lessonID" type="text" value="" required="true">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input id="ordinal" name="ordinal" type="number" value="" required="true">
    </div>
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input id="level" name="level" type="number" value="" required="true">
    </div>
    <div class="form-group">
